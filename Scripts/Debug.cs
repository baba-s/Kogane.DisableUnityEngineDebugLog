...
public class Debug
{
	...
	[Conditional(CONDITION_STRING)] public static void DrawLine(Vector3 start, Vector3 end, Color color, float duration, bool depthTest) {}
	...
	[Conditional(CONDITION_STRING)] public static void DrawRay(Vector3 start, Vector3 dir, Color color, float duration, bool depthTest) {}
